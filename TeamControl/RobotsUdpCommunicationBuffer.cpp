...
const unsigned char RobotsUdpCommunicationBuffer::art_leer			        = 0;
const unsigned char RobotsUdpCommunicationBuffer::art_ausgang_normal		= 1;
const unsigned char RobotsUdpCommunicationBuffer::art_ausgang_rueckschein	= 2;
const unsigned char RobotsUdpCommunicationBuffer::art_ausgang_rueckscheinantwort = 3;
const unsigned char RobotsUdpCommunicationBuffer::art_eingang_normal		= 11;
const unsigned char RobotsUdpCommunicationBuffer::art_version_info			= 20;

const unsigned char RobotsUdpCommunicationBuffer::prio_wichtig			= 0;
const unsigned char RobotsUdpCommunicationBuffer::prio_normal			= 1;
const unsigned char RobotsUdpCommunicationBuffer::prio_optional		= 2;

RobotsUdpCommunicationBuffer::RobotsUdpCommunicationBuffer(unsigned int eintraege)
{
...
RobotsUdpCommunicationBuffer::~RobotsUdpCommunicationBuffer()
{
	log_status();
...
void RobotsUdpCommunicationBuffer::print_hex(ostream * output,char * src,unsigned int size)
{
//	unsigned short _tmp;
...
void RobotsUdpCommunicationBuffer::print_inhalt(char * src,unsigned int size,unsigned short art)
{
//	unsigned short _tmp;
	unsigned char _tmp_wert;
/*
...
void RobotsUdpCommunicationBuffer::log_status()
{
...
unsigned int RobotsUdpCommunicationBuffer::find_next_art(unsigned char art)
{
	unsigned int _pos=0;
...
unsigned char RobotsUdpCommunicationBuffer::checksum(char * src,unsigned int size)
{
...
bool RobotsUdpCommunicationBuffer::put_to_buffer(char * src,unsigned int size,bool rueckschein,unsigned char prio)
{
//log_status();
...
void RobotsUdpCommunicationBuffer::put_to_buffer_rueckscheinantwort(unsigned int paketnummer,unsigned char checksum,unsigned int nutzdatenlaenge)
{
...
void RobotsUdpCommunicationBuffer::del_from_buffer_rueckschein(unsigned int paketnummer,unsigned char checksum,unsigned int nutzdatenlaenge)
{
...
unsigned int RobotsUdpCommunicationBuffer::get_send_buffer(char * dest,unsigned int maxsize, unsigned int version)
{
//log_status();
...
bool RobotsUdpCommunicationBuffer::set_receive_buffer(char * src,unsigned int src_size,unsigned int version)
...
unsigned int RobotsUdpCommunicationBuffer::get_next_buffer(char * dest,unsigned int dest_maxsize)
{
	unsigned int _pos;
	_pos=find_next_art(art_eingang_normal);
	if (_pos>=max_eintraege) return 0; 
	
	if (puffer[_pos]->nutzdatenlaenge>dest_maxsize) 
	{
		JWARNING("puffer[_pos]->nutzdatenlaenge>dest_maxsize");
		e_get_next_buffer_tobig++;
		puffer[_pos]->art=art_leer;
		return get_next_buffer(dest,dest_maxsize); 
	}
