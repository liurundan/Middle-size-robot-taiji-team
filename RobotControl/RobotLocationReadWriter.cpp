...
void RobotLocationWriter::write (unsigned long int tav, unsigned long int t1, 
								 const RobotLocation& rloc_vis, unsigned long int t2, 
								 const RobotLocation& rloc_exec) throw () 
{
  dest << tav << '\t'
       << t1 << '\t'
       << rloc_vis.pos.x << '\t' 
