...
VisualContainer::VisualContainer () throw ( bad_alloc) 
{
...
void VisualContainer::add (const VisibleObjectList& vis) throw ( bad_alloc) 
{
  ...
  vector<VisibleObject>::const_iterator it    = vis.objectlist.begin();
  vector<VisibleObject>::const_iterator itend = vis.objectlist.end();
  while (it<itend) 
  {
...
void VisualContainer::add (const VisibleObject& obj, MyTime t) throw ( bad_alloc) 
{
...
void VisualContainer::shuffle_lines () throw ( bad_alloc )
{
