...
Image* 
  ...
  unsigned char UYVYImage::getPixelClass(int x, int y) const
  {
  ...
  void UYVYImage::setPixelYUV(int x, int y, const YUVTuple& yuv)
  {
    int pos = y*buffer.width+x;
  ...
  void UYVYImage::setPixelRGB(int x, int y, const RGBTuple& rgb)
  {
    int pos = y*buffer.width+x;
    int y0, u, v, r, g, b;
  ...
  void UYVYImage::setPixelUYVY(int x, int y, const UYVYTuple& uyvy)
  {
